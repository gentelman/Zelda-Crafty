...
//Componente contador de rupia y funcion incrementar disminuir rupias en el contador
  Crafty.c("rupiaCounter", {
  	_rupiaCounter: 0,
  	
  	incrementRupia: function(by) {
  	
  		this._rupiaCounter += by;

  		
  		return this;
  	},
  	
  	decrementRupia: function(by) {
  		this._rupiaCounter -= by;
  		return this;
  	}
  });
